...
public class PrestamosNegocioImpl implements IPrestamosNegocio{
	...
	public List<Prestamos> queryFiltro(String campo, String criterio, String filtro) {
		...
		String query= "SELECT P.NumPrestamo_P,P.NumCuenta_P, P.ImportePagar_P, P.ImportePedido_P, P.PlazoPago, C.IdUsuario_Cta,P.Estado FROM prestamos as P INNER JOIN cuenta C on P.NumCuenta_P where ";
		try {
